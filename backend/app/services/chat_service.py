...
class ChatService:
    ...
    async def generate_message_and_latex(prompt: str) -> tuple[str, str]:
        ...
        system_instructions = (
            ...
            "### TEMPLATE OPTIONS\n"
            "You have access to LaTeX templates that can help you generate better code. Available templates include: resume, textbook, research, presentation, letter, report. "
            "If the user's request matches one of these document types, you can retrieve a template using the 'get_latex_template' tool for context and inspiration.\n\n"
            "### OUTPUT CONTRACT\n"
